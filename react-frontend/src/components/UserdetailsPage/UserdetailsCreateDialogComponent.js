...
const UserdetailsCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        ...
        props.onHide();
        props.alert({ type: "success", title: "Create info", message: "Info userdetails updated successfully" });
    ...
    return (
        <Dialog header="Create" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            ...
            <div>
                ...
                <Dropdown value={_entity?.username} optionLabel="name" optionValue="value" options={usernameOptions} onChange={(e) => setValByKey("username", e.value)} />
            </div>
            <div>
